/**
 * Orders Component
 * Maneja la visualización y gestión de órdenes del usuario
 */
...
export class Orders {
    constructor() {
        this.myOrdersList = document.getElementById('myOrdersList');
        this.init();
    }
    ...
    renderOrders(orders) {
        ...
        this.myOrdersList.innerHTML = '';
        
        // Limpiar el displayName del localStorage
        try {
    ...
    async showOrderDetails(orderId) {
        try {
            ...
            this.createOrderDetailsModal(orderDetails);
        } catch (e) {
    ...
    createOrderDetailsModal(order) {
        ...
        const orderNumber = order.OrderNumber || order.orderNumber || order.OrderId || order.orderId || order.id || 'N/A';
        ...
        orderInfo.style.cssText = `margin-bottom: 20px;`;
        ...
        itemsList.style.cssText = `display: grid; gap: 12px;`;
